...
def get_BT_relatedwords(farleftfile, leftfile, centerfile, rightfile, farrightfile):
    ...
    Breonna_related_FL = search_related_words(farleft_text, ['floyd'])
    Breonna_related_L = search_related_words(left_text, ['floyd'])
    Breonna_related_C = search_related_words(center_text, ['floyd'])
    Breonna_related_R = search_related_words(right_text, ['floyd'])
    Breonna_related_FR = search_related_words(farright_text, ['floyd'])
    Breonna_related_AT = search_related_words(all_text, ['floyd'])


    a = pf.plot_freqWords(Breonna_related_FL, 'George Floyd Far left related words')
    b = pf.plot_freqWords(Breonna_related_L, 'George Floyd left related words')
    c = pf.plot_freqWords(Breonna_related_C, 'George Floyd Center related words')
    d = pf.plot_freqWords(Breonna_related_R, 'George Floyd Right related words')
    e = pf.plot_freqWords(Breonna_related_FR, 'George Floyd Far Right related words')
    f = pf.plot_freqWords(Breonna_related_AT, 'George Floyd all related words')
