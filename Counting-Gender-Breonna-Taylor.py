...
# Functions
# Input: text, dictionary of indicators
# Output: the number of indicators in the text
...
all_text = farleft_text + left_text + center_text + right_text + farright_text

# Get the male gender indicators within each type of text
...
# Get the female gender indicators within each type of text
...
# Use this to see the numbers for each of the indicators
